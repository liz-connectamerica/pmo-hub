...
One thing worth knowing: only an admin can reassign a project's **Owner**, and only an admin can delete a project — both of those are unavailable even to the current owner (Delete lives next to the People tab's Edit button, at the top of that tab).
