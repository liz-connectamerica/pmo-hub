...
- **My Work** — My Projects, My Tasks, My Work Requests (this section appears once your account is linked to a resource, since My Tasks always has a personal use — adding a to-do for yourself — even before you're connected to any project or work request)
...
These show up in the sidebar once your account is linked to a resource. My Projects and My Work Requests will be empty until you actually have some connection to a project or work request, but My Tasks always has something useful to offer — it's where you manage your own personal to-dos, connection or not.
